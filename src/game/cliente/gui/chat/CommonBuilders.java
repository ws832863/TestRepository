...
/**
 * This is a helper class of reused builders so that we don't repeat ourself too
 * much.
 * 
 * @author void
 */
public class CommonBuilders {
	...
	public EffectBuilder createMoveEffect(final String mode,
			final String direction, final int length) {
	...
	public LabelBuilder createLabel(final String id, final String text,
			final String width) {
